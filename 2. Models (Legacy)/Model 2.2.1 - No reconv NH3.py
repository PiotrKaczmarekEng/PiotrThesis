...
# latitude = 57.35    # Optimal location for j1 and j2
# longitude = 7.78
latitude = 54.35    # Optimal location for j3 and j4
longitude = 6.78
# # Production central coordinates (complete study)
# latitude = 54.35
# longitude = 6.28
...
for iteration_SSP in range(1):
    ...
    for iteration_j in range(2,4):        # range(2) to study optimal location of j1 and j2, range(2,4) for j3 and j4
        ...
        with pd.ExcelWriter("csv_files/"+sensitivity_file_path+"Output_j"+str(E+1)+".xlsx") as writer:
        ...
        # create a excel writer object
        with pd.ExcelWriter("csv_files/"+sensitivity_file_path+"LCOH_j"+str(E+1)+".xlsx") as writer:
        ...
        # create a excel writer object
        with pd.ExcelWriter("csv_files/"+sensitivity_file_path+"CostDistribution_j"+str(E+1)+".xlsx") as writer:
