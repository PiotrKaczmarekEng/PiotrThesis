...
longitude = 126.94
# Solar and Wind 
multsolar = 524*1000/206.7989   # Installed capacity per unit [kWp]
multwind = 12/3   # Capacity per unit [MW]
...
# Add resulting objective value to the dataframe
df.loc[0,'ObjVal'] = model.ObjVal

df.to_csv("test_csv.csv")


fig = px.density_mapbox(df, lat = 'latitude', lon = 'longitude', z = 'ObjVal',
                        radius = 7,
